...
function convertAudioToBinaryMessage(audioChunk) {
    ...
    $('#audiochunk').val(binary.toString());
    $('#downsampledBuffer').val(downsampledBuffer.toString());
    $('#pcmEncodedBuffer').val(pcmEncodedBuffer.toString());
    $('#audioEventMessage').val(audioEventMessage.toString());
